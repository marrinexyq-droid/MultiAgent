const featureCards = [
  {
    ...
    "text": "Inferred 5 main sections from the screenshot's vertical transitions."
  },
  {
    "title": "COLOR SYSTEM",
    "text": "Primary color adapts to #15224A with accent support from #3D88FF."
  },
  {
    "title": "PAGE TYPE",
                  ...
                  <div className="hero-card">
                    ...
                    <div className="hero-card-grid">
                      ...
                      <div>
                        ...
                        <strong>ADAPTIVE DASHBOARD PAGE</strong>
                      </div>
                      <div>
