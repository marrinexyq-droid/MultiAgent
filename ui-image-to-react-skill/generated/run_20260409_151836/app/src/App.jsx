      ...
      <main id="top">
        <section className="hero-section container">
          <div className="hero-copy">
            <div className="eyebrow">REFERENCE-DRIVEN UI SYSTEM</div>
            <h1>BUILD A PAGE FROM A VISUAL REFERENCE</h1>
            <p>This starter page mirrors the reference image's layout intent and leaves clear hooks for swapping in generated copy, images, and sections.</p>
          ...
          <div className="hero-card">
            ...
            <div className="hero-card-grid">
              ...
              <div>
                ...
                <strong>MOTHERDUCK 风格产品页</strong>
              </div>
              <div>
